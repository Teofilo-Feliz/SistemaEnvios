...
export const catalogoService = {
  ...
  allLocations: (params = {}) => todasLasPaginas((p) => api.get('/ubicaciones', { params: { ...params, ...p } })),
  allTypes: (params = {}) => todasLasPaginas((p) => api.get('/tipos-equipos', { params: { ...params, ...p } })),
  allStates: (params = {}) => todasLasPaginas((p) => api.get('/estados-envio', { params: { ...params, ...p } })),
  allTransportTypes: (params = {}) => todasLasPaginas((p) => api.get('/tipos-transporte', { params: { ...params, ...p } })),
  allInternalDrivers: (params = {}) => todasLasPaginas((p) => api.get('/choferes-internos', { params: { ...params, ...p } })),
