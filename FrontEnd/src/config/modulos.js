...
/** Configuración del perfil, o null si no tiene restricción (o si aún no se conoce). */
export function modulosDe(perfil) {
  if (!perfil) return SIN_RESTRICCION;
  return MODULOS_POR_PERFIL[perfil] ?? SIN_RESTRICCION;
}
