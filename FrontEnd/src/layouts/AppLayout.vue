...
const ui = useUiStore()
function syncViewport() { if (window.innerWidth >= 1024) ui.mobileOpen = false }
...
<template>
  <div class="app-shell" :class="{ 'is-collapsed': ui.collapsed }">
    <AppSidebar />
    <button v-if="ui.mobileOpen" class="sidebar-backdrop" aria-label="Cerrar menú" @click="ui.mobileOpen = false" />
    <div class="app-main">
      <AppTopbar />
